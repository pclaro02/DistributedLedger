...
public class AdminConnectionResources {
    ...
    private AdminServiceGrpc.AdminServiceBlockingStub serviceServerStub;
    private String serverAddressInUse;

    public AdminConnectionResources(NamingServerServiceGrpc.NamingServerServiceBlockingStub namingServerStub, String serviceName, String associatedQualifier) {
    ...
    public AdminServiceGrpc.AdminServiceBlockingStub getServiceServerStub() {
    ...
    public void openServiceServerChannel() {
        ...
        this.serviceServerStub = AdminServiceGrpc.newBlockingStub(serviceServerChannel);
    }
